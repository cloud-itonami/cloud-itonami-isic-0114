# Operator Quickstart — Sugar-Cane Plantation Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0114** (`cloud-itonami-isic-0114`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0114.git
cd cloud-itonami-isic-0114
```
...
- Blueprint governor key: `cane-operations-governor`
- Likely source path: `caneops.governor.cljc`
