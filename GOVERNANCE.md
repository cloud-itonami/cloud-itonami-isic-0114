...
operation, finalizing a pre-harvest-burn or pesticide-application decision,
and any non-`:propose` effect are permanently blocked; `:high`/
`:safety-critical` actions (crop-health/pest concerns, high-cost supply
